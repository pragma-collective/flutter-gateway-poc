...
void _messageSerialize(
  ...
  writer.writeBool(offsets[1], object.processed);
...
Message _messageDeserialize(
  ...
  object.id = id;
  object.processed = reader.readBool(offsets[1]);
...
extension MessageQueryFilter
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> processedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> receivedAtEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> receivedAtGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> receivedAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> receivedAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> retryCountEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> retryCountGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> retryCountLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Message, Message, QAfterFilterCondition> retryCountBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MessageQuerySortBy on QueryBuilder<Message, Message, QSortBy> {
  ...
  QueryBuilder<Message, Message, QAfterSortBy> sortByProcessed() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'processed', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> sortByProcessedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'processed', Sort.desc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> sortByReceivedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'receivedAt', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> sortByReceivedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'receivedAt', Sort.desc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> sortByRetryCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'retryCount', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> sortByRetryCountDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageQuerySortThenBy
  ...
  QueryBuilder<Message, Message, QAfterSortBy> thenByProcessed() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'processed', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> thenByProcessedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'processed', Sort.desc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> thenByReceivedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'receivedAt', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> thenByReceivedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'receivedAt', Sort.desc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> thenByRetryCount() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'retryCount', Sort.asc);
    });
  }

  QueryBuilder<Message, Message, QAfterSortBy> thenByRetryCountDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'retryCount', Sort.desc);
    });
  }
...
extension MessageQueryWhereDistinct
  ...
  QueryBuilder<Message, Message, QDistinct> distinctByProcessed() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'processed');
    });
  }

  QueryBuilder<Message, Message, QDistinct> distinctByReceivedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'receivedAt');
    });
  }

  QueryBuilder<Message, Message, QDistinct> distinctByRetryCount() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageQueryProperty
  ...
  QueryBuilder<Message, bool, QQueryOperations> processedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'processed');
    });
  }

  QueryBuilder<Message, DateTime, QQueryOperations> receivedAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'receivedAt');
    });
  }

  QueryBuilder<Message, int, QQueryOperations> retryCountProperty() {
    return QueryBuilder.apply(this, (query) {
